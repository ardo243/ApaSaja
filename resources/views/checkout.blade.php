...
<body class="bg-indigo-50/30 text-slate-900">
    ...
    <main class="max-w-3xl mx-auto px-6 py-20">
        <div class="mb-12">
            <a href="{{ url('/event') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6">
    ...
    <div id="midtrans-overlay"
        ...
        <div class="mt-8 space-y-4">
            <a href="{{ url('/ticket') }}"
            class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 hover:border-indigo-600 transition group block">
